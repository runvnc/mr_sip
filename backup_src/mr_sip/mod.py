...
from .sip_manager import get_session_manager, SIPSession
from .baresip_integration import MindRootSIPBot, setup_sndfile_module
...
logger.info("MindRoot SIP plugin loaded")
