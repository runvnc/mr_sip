...
class MindRootSIPBotV2(BareSIP):
    ...
    def __init__(self, user, password, gateway, audio_dir=".", 
        ...
        # Track last eager EOT text to prevent duplicate sends
    ...
    def _on_partial_result(self, result: STTResult):
        ...
        if result.text != self.last_partial_text:
            ...
            if hasattr(result, 'is_eager_eot') and result.is_eager_eot:
                ...
                # Store the eager EOT text to prevent duplicate sends
    ...
    def _handle_turn_resumed(self):
        ...
        print("[DEBUG TRACE 2/6] SIP client's _handle_turn_resumed callback triggered.")
        ...
        # Clear the eager EOT tracking since user interrupted
        self.last_eager_eot_text = ""
